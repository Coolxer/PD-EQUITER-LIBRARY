...
"""
    Wejście (Parametry metod) [wymagania dla parametrów -> patrz: validator]:
        ...
        - w (liczba zmiennoprzecinkowa) [tylko dla metody SOR] - parametr relaksacji
    ...
    Wyjście (Wartości zwracane przez metodę common, a nie przez właściwą metodę):
            ...
            - valid (bool) - informacja czy wszystko przebiegło pomyślnie (dla poprawnych danych wejściowych zawsze True)
